...
\newcommand{\documentVerifier}{Nome del verificatore}
\newcommand{\documentListVerifier}{
	\begin{itemize}[leftmargin=*]
		\item[] Cognome1 Nome1
		\item[] Cognome2 Nome 2
	\end{itemize}
...
\newcommand{\documentApprovate}{Nome dell'approvatore}

\newcommand{\redactionDate}{\today}
\newcommand{\documentScope}{Scopo generico}
\newcommand{\documentVersion}{v.0.0.0}